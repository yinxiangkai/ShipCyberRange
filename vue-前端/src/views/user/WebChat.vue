...
export default {
  ...
  methods: {
    ...
    createContent(remoteUser, nowUser, text) {  // 这个方法是用来将 json的聊天消息数据转换成 html的。
      ...
      if (nowUser) { // nowUser 表示是否显示当前用户发送的聊天消息，绿色气泡
        html = "<div class=\"el-row\" style=\"padding: 5px 0\">\n" +
            ...
            "    <img src=\"https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png\" style=\"object-fit: cover;\" alt=\'头像\'>\n" +
            "  </span>\n" +
            "  </div>\n" +
            "</div>";
    ...
    init() {
      this.user =Cookies.get('cookie')? JSON.parse(Cookies.get('cookie')):{}
